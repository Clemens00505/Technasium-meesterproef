    ...
    <div class="services__content">
        ...
        <div class="services__modal">
            ...
            <section class="contact section" id="contact">
                ...
                <span class="section__subtitle">questions or do you want to book send a message</span>
                ...
                <div class="contact__container container grid">
                    ...
                    <form action="" class="contact__form grid">
                        <div class="contact__inputs grid">
                            ...
                            <div class="contact__content">
                                <label class="contact__labal">What is your e-mail adress?</label>
                        ...
                        <div class="contact__content">
                            <label class="contact__labal">What message do you want to sent us?</label>
